...
class CrearCliente():
    ...
    def __init__(self, Menu): 
        ...
        #self.btnAgregar = tk.Button(self.ventana, text="Agregar", width=8, command=self.agregar)
        #self.btnAgregar.place(x=70, y=260)
        #Tooltip(self.btnAgregar, "Presione para Registrarse como usuario o presione la tecla 'Enter'.\n")

        #self.btnLimpiar = tk.Button(self.ventana, text="Limpiar", width=8, command=self.limpiar)
        #self.btnLimpiar.place(x=162, y=260)
        #Tooltip(self.btnLimpiar, "Presione para Limpiar los campos de texto.\nAlt+l")
        
        #self.btnSalir = tk.Button(self.ventana, text="Salir", width=5, command=self.salir)
        ...
        self.btnSalir.place(x=255, y=250)
        Tooltip(self.btnSalir, "Presione para Salir de la Aplicación.\nAlt+s")
        ...
        self.btnLimpiar.place(x=170, y=250)
        Tooltip(self.btnLimpiar, "Presione para Limpiar los campos de texto.\nAlt+l")
        
        iconoAgregar= tk.PhotoImage(file= r"icons\user_add.png")
        self.btnAgregar = tk.Button(self.ventana, text="Agregar", width=60, height=20, command=self.agregar,image=iconoAgregar, compound=LEFT, state="disabled")
        self.btnAgregar.place(x=80, y=250)
        Tooltip(self.btnAgregar, "Presione para Agregar como usuario o presione la tecla 'Enter'.\n")
